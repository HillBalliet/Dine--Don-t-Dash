...
- (void)viewDidLoad
{
    foodItems = [[NSArray alloc] initWithObjects:@"Kit Kat", @"Clementines", @"Chocolate", @"Pizza", @"Creme Brulee", @"Caviar", @"Sushi", @"Pate", @"Pastries", @"Bagels", @"Doughnuts", nil];
    stockNumbers = [[NSMutableArray alloc] initWithArray:@[@35, @22, @36, @10, @3, @5, @8, @2, @23, @32, @47]];
    itemPrices = [[NSMutableArray alloc] initWithArray:@[@0.60f, @0.40f, @0.60f, @1.20f, @1.50f, @3.90f, @2.70f, @2.30f, @1.20f, @1.00f]];
