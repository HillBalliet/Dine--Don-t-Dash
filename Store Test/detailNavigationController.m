...
- (void)navigationBar:(UINavigationBar *)navigationBar shouldPopItem:(UINavigationItem *)item{
    if (!isNesting) {
        if ([[NSString stringWithFormat:@"%@", [[[self.splitViewController.viewControllers objectAtIndex:0] topViewController] class]] isEqualToString:@"storeTableViewController"]) {
...
- (void) navigationBar: (UINavigationBar *) navigationBar shouldPushItem:(UINavigationItem *)item{
    if ([[NSString stringWithFormat:@"%@", [[[self.splitViewController.viewControllers objectAtIndex:1] topViewController] class]] isEqualToString:@"PageViewController"]){
        ...
        if ([[NSString stringWithFormat:@"%@", [[[self.splitViewController.viewControllers objectAtIndex:0] topViewController] class]] isEqualToString:@"PageViewController"]) {
            isUnderStore = true;
    ...
    else if ([[NSString stringWithFormat:@"%@", [[[self.splitViewController.viewControllers objectAtIndex:0] topViewController] class]] isEqualToString:@"PageViewController"]){
    }
}
