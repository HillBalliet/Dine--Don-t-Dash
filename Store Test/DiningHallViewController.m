...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == diningHallTableView) {
        ...
        mainCell.detailTextLabel.text = [cell costOfMeal];
        ...
        [app setCell:cell viewController:self];
...
-(void)displayComposerSheet
{
	...
	NSString *emailBody = @"These are the files for the charges made in the Dining Hall";
...
{
	NSString *recipients = @"mailto:wballiet@indiansprings.org, ahamner@indiansprings.org, aberry@indiansprings.org?&subject=Dining Hall Meals";
